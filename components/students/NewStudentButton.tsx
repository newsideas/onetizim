...
export function NewStudentButton({ groups }: { groups: GroupOption[] }) {
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Yangi o'quvchi qo'shish">
        {groups.length === 0 ? (
          <p className="text-sm text-white/60">
            Avval kamida bitta guruh yarating (Guruhlar sahifasida), keyin
            o&apos;quvchi qo&apos;shishingiz mumkin.
          </p>
        ) : (
